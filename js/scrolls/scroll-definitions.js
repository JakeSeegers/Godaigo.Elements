...
const WIND_SCROLL_EFFECTS = {
    ...
    4: { name: 'Take Flight', description: "Select a player to teleport. If you target yourself, you choose where to land; if you target another player, they choose instead. Destination must be an unoccupied hex on a tile occupied by another player. Cannot target player tiles. Cancels if no valid destination exists. If targeting an opponent, Take Flight goes to their hand; if targeting yourself, it stays in your active area." },
...
const CATACOMB_SCROLL_EFFECTS = {
    ...
    3: { name: 'Call to Adventure', description: 'You may flip one unoccupied tile. Until end of turn, when you reveal a tile, immediately draw Elemental Stones as if you had ended your turn on that tile\'s center.' },
